...
const raisedToTheThird = (arr) => {
  ...
  let thirdArr = [];
  arr.forEach((num) => {
    let newPower = Math.pow(num, 3);
    thirdArr.push(newPower);
  });
  return thirdArr;
};
...
const addOne = (arr) => {
  // Solution code here...
  let oneArr = arr.map(numOne => numOne + 1);
  return oneArr;
};
/* ------------------------------------------------------------------------------------------------
CHALLENGE 3
...
const forEachTwoToThe = (arr) => {
  ...
  let newArray = [];
  arr.forEach((number) => {
    let newPower = Math.pow(2, number);
    newArray.push(newPower);
  });
  return newArray;
};
...
const mapTwoToThe = (arr) => {
  ...
  let newPower = arr.map(number => Math.pow(2, number));
  return newPower;
};
/* ------------------------------------------------------------------------------------------------
